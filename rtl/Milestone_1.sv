...
*/
always_comb begin
    y_even_sum = (multi0 + multi1) + (multi2 + 32'h00108000);
    y_even_calc = (y_even_sum[31]) ? 8'd0 : (|y_even_sum[30:24]) ? 8'd255 : y_even_sum[23:16];
end
...
*/
always_comb begin
    y_odd_sum = (multi1 + multi2) + (multi3 + 32'h00108000);
    y_odd_calc = (y_odd_sum[31]) ? 8'd0 : (|y_odd_sum[30:24]) ? 8'd255 : y_odd_sum[23:16];
end
...
*/
always_comb begin
    u_even_prime_sum = (multi0 + multi1) + (ACC_reg_0 + 32'h00808000);
    u_even_prime_calc = (u_even_prime_sum[31]) ? 8'd0 : (|u_even_prime_sum[30:24]) ? 8'd255 : u_even_prime_sum[23:16];
end
...
*/
always_comb begin
    u_odd_prime_sum = (multi0 + multi1) + (multi2 + 32'h00808000);
    u_odd_prime_calc = (u_odd_prime_sum[31]) ? 8'd0 : (|u_odd_prime_sum[30:24]) ? 8'd255 : u_odd_prime_sum[23:16];
end
...
*/
always_comb begin
    v_even_prime_sum = multi0 + (ACC_reg_1 + 32'h00808000); // ACC_reg_1 = multi2 + multi3
    v_even_prime_calc = (v_even_prime_sum[31]) ? 8'd0 : (|v_even_prime_sum[30:24]) ? 8'd255 : v_even_prime_sum[23:16];
end
...
*/
always_comb begin
    v_odd_prime_sum = (multi0 + multi1) + (ACC_reg_0 + 32'h00808000); // ACC_reg_0 = multi3
    v_odd_prime_calc = (v_odd_prime_sum[31]) ? 8'd0 : (|v_odd_prime_sum[30:24]) ? 8'd255 : v_odd_prime_sum[23:16];
end

//sum, shift and clipping U 
always_comb begin
	u_sum = (multi0 + ACC_reg_1) + ({16'b0, U_even_shift_Reg[0], 8'b0} + p256); //ACC_reg_1 = multi2 + multi3
	u_calc = (u_sum[31]) ? 8'd0 : (|u_sum[30:17]) ? 8'd255 : u_sum[16:9];
end
//sum, shift and clipping V 
always_comb begin
	v_sum = (multi1 + multi2) + (multi3 + ({16'b0, V_even_shift_Reg[0], 8'b0} + p256)); //ACC_reg_1 = multi2 + multi3
	v_calc = (v_sum[31]) ? 8'd0 : (|v_sum[30:17]) ? 8'd255 : v_sum[16:9];
end
